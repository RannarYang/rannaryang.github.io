...
(function (ui) {
    ...
    MenuUI.uiView = { "type": "View", "props": { "width": 1024, "height": 40 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 1024, "skin": "menu/menuBg.png" } }] };
    ui.MenuUI = MenuUI;
})(ui || (ui = {}));
(function (ui) {
    var test;
...
(function (ui) {
    var YouWinUI = (function (_super) {
        __extends(YouWinUI, _super);
        function YouWinUI() {
            return _super.call(this) || this;
        }
        YouWinUI.prototype.createChildren = function () {
            View.regComponent("Text", laya.display.Text);
            _super.prototype.createChildren.call(this);
            this.createView(ui.YouWinUI.uiView);
        };
        return YouWinUI;
    }(View));
    YouWinUI.uiView = { "type": "View", "props": { "width": 1024, "height": 702 }, "child": [{ "type": "Sprite", "props": { "y": 0, "x": 0, "alpha": 0.7 }, "child": [{ "type": "Rect", "props": { "width": 1024, "lineWidth": 1, "height": 702, "fillColor": "#000000" } }] }, { "type": "Text", "props": { "y": 276, "x": 255, "text": "You Win!", "fontSize": "130", "color": "#ffffff" } }] };
    ui.YouWinUI = YouWinUI;
})(ui || (ui = {}));
